...
// Admin-gating now happens SERVER-SIDE in page.tsx (lib/admin-auth). This is the
// interactive explorer it renders once the caller is a verified admin.
export default function ArchitectureExplorer() {
  ...
  return (
    <main className="flex-1 max-w-7xl w-full mx-auto px-4 py-6 space-y-6" dir="rtl">
      ...
      {/* Live system pulse — the state the V2 work produces (phase, last decision, tier). */}
      <SystemPulse />
      ...
      <footer className="text-xs text-[var(--c-stone)] text-center pt-4 border-t border-[rgba(238,237,232,0.08)]">
        Architecture v2 • {BLOCKS.length} blocks • admin-only • live pulse above
      </footer>
    </main>
  );
}
